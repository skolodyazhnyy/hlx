 ...
 */
let HlxBadgeElement = class HlxBadgeElement extends s {
    render() {
        return y `<slot></slot>`;
    }
};
HlxBadgeElement.styles = i$2 `
    :host {
      display: flex;
      align-items: center;
 ...
 * @csspart button - The button
 */
let HlxMinicartElement = class HlxMinicartElement extends s {
    constructor() {
        super(...arguments);
        /**
    ...
    render() {
        return y `<button @click=${this._onClick}>
          <slot name="icon">
 ...
 * @csspart button - The button
 */
let HlxShoppingCartElement = class HlxShoppingCartElement extends s {
    render() {
        return y `
...
HlxShoppingCartElement.styles = i$2 `
    :host {
      display: block;
      width: 24px;
      height: 24px;
...
HlxShoppingCartElement = __decorate([
    e$1('hlx-shoppingcart-icon')
], HlxShoppingCartElement);

export { HlxBadgeElement, HlxMinicartElement, HlxShoppingCartElement };
